...
## RevenueCat SDK
### ✨ New Features
* feat(singular): add setSingularDeviceID passthrough for Singular V2 (#1845) via Guillem Corominas (@guillemcorominas)
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.86.0 => 5.87.0 Android 10.18.1 => 10.19.0 JS 1.53.1 => 1.54.0 (#1847) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC] iOS 5.85.0 => 5.86.0 (#1840) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* chore: don't run danger on main (#1842) via Cesar de la Vega (@vegaro)
...
## RevenueCat SDK
### ✨ New Features
* feat(ads): ad reward tracking support (#1804) via Peter Porfy (@peterporfy)
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.84.0 => 5.85.0 Android 10.17.0 => 10.18.0 (#1830) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC] JS 1.52.3 => 1.53.0 (#1826) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane from 2.237.0 to 2.238.0 (#1822) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `7fbbe66` to `7dd9ab9` (#1828) via dependabot[bot] (@dependabot[bot])

## 18.31.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.83.2 => 5.84.0 Android 10.16.2 => 10.17.0 (#1823) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC] JS 1.52.1 => 1.52.3 (#1820) via RevenueCat Git Bot (@RCGitBot)
* [RENOVATE] Update dependency revenuecat to v4.6.0 (#1819) via RevenueCat Git Bot (@RCGitBot)

## 18.30.1
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.83.1 => 5.83.2 Android 10.16.1 => 10.16.2 JS 1.52.0 => 1.52.1 (#1816) via RevenueCat Git Bot (@RCGitBot)

## 18.30.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] JS 1.51.2 => 1.52.0 (#1813) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC] iOS 5.83.0 => 5.83.1 Android 10.16.0 => 10.16.1 JS 1.51.0 => 1.51.2 (#1810) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC] JS 1.49.1 => 1.51.0 (#1803) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Disable update_fastlane in CI (#1814) via Álvaro Brey (@AlvaroBrey)
* Bump json from 2.20.0 to 2.21.2 (#1812) via dependabot[bot] (@dependabot[bot])
* Bump js-yaml from 4.3.0 to 4.3.1 in /typescript (#1811) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `b4e1e7f` to `7fbbe66` (#1809) via dependabot[bot] (@dependabot[bot])
* Bump fast-uri from 3.1.4 to 3.1.5 in /typescript (#1806) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `dd577ee` to `b4e1e7f` (#1805) via dependabot[bot] (@dependabot[bot])
* Bump danger from 9.6.0 to 9.6.1 (#1802) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `3421c88` to `dd577ee` (#1800) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.82.0 => 5.83.0 Android 10.15.1 => 10.16.0 (#1796) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.78.0 => 5.79.0 Android 10.9.1 => 10.10.0 JS 1.42.4 => 1.45.0 (#1703) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Use mise for JDK management (#1699) via Álvaro Brey (@AlvaroBrey)
* Bump nokogiri from 1.19.3 to 1.19.4 (#1701) via dependabot[bot] (@dependabot[bot])
* Bump danger from 9.5.3 to 9.6.0 (#1700) via dependabot[bot] (@dependabot[bot])
* Bump sdks-common-config orb to 4.1.0 and migrate output to outputs (#1697) via Álvaro Brey (@AlvaroBrey)
* Adopt generated PURCHASES_ERROR_CODE (#1693) via Álvaro Brey (@AlvaroBrey)
* Pass purchases-js-hybrid-mappings sha256 to purchases-flutter bump (#1690) via Antonio Pallares (@ajpallares)
* chore: Add 3-day Dependabot cooldown, excluding fastlane plugin (#1691) via Toni Rico (@tonidero)

## 18.15.1
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] Android 10.9.0 => 10.9.1 JS 1.42.3 => 1.42.4 (#1688) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `ce6a7ef` to `70bf5c7` (#1687) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.236.0 to 2.236.1 (#1685) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] Android 10.8.0 => 10.9.0 JS 1.42.1 => 1.42.3 (#1676) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane from 2.235.0 to 2.236.0 (#1674) via dependabot[bot] (@dependabot[bot])

## 18.12.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.76.0 => 5.78.0 JS 1.42.0 => 1.42.1 (#1671) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.70.0 => 5.71.0 Android 10.3.1 => 10.4.0 JS 1.38.0 => 1.39.0 (#1637) via RevenueCat Git Bot (@RCGitBot)
...
### 📦 Dependency Updates
* [AUTOMATIC] Android 9.26.1 => 9.27.0 (#1573) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC] iOS 5.65.0 => 5.66.0 JS 1.28.0 => 1.29.0 (#1570) via RevenueCat Git Bot (@RCGitBot)

## RevenueCatUI SDK
### Paywallv2
#### ✨ New Features
* Add promotional offer success callback (#1527) via Cesar de la Vega (@vegaro)
...
## RevenueCat SDK
### ✨ New Features
* [SDK-4265] Add PaywallListener and PurchaseLogic bridge support for Capacitor (#1501) via Toni Rico (@tonidero)
* Implemented support for passing custom PurchaseLogic to PaywallView from hybrids (#1494) via Rick (@rickvdl)
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.59.0 => 5.59.2 JS 1.26.0 => 1.26.1 (#1507) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Add internal API to debug tracked events (#1502) via Antonio Pallares (@ajpallares)
* Bump nokogiri from 1.19.0 to 1.19.1 (#1506) via dependabot[bot] (@dependabot[bot])
...
### 🔄 Other Changes
* Add internal API to debug tracked events (#1443) via Toni Rico (@tonidero)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.50.0 => 5.50.1 Android 9.15.3 => 9.15.5 JS 1.20.0 => 1.21.0 (#1404) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `efca663` to `76a3a08` (#1401) via dependabot[bot] (@dependabot[bot])
* Add 17.22.0 to CHANGELOG (#1400) via Toni Rico (@tonidero)
* Updated CircleCI macos executor from m1 to m4 to avoid deprecation (#1399) via Rick (@rickvdl)

## 17.23.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.49.3 => 5.50.0 Android 9.15.2 => 9.15.3 (#1397) via RevenueCat Git Bot (@RCGitBot)

## 17.22.0
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.49.2 => 5.49.3 Android 9.15.1 => 9.15.2 JS 1.18.4 => 1.20.0 (#1394) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.49.0 => 5.49.1 Android 9.15.0 => 9.15.1 JS 1.18.3 => 1.18.4 (#1384) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.45.0 => 5.46.0 Android 9.12.0 => 9.12.1 JS 1.17.0 => 1.17.1 (#1347) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC] iOS 5.40.0 => 5.41.0 Android 9.7.2 => 9.8.0 (#1317) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Add CODEOWNERS (#1318) via Antonio Pallares (@ajpallares)
* Bump fastlane-plugin-revenuecat_internal from `7508f17` to `e555afb` (#1316) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 💥 Breaking Changes
* iOS: Add getCachedVirtualCurrencies + Fix getVirtualCurrencies API (#1209) via Will Taylor (@fire-at-will)
### ✨ New Features
* Expose VC APIs in Android PHC (#1206) via Will Taylor (@fire-at-will)
* [purchases-js-hybrid-mappings] Support `setAttributes` (#1210) via Toni Rico (@tonidero)
### 📦 Dependency Updates
